/********************************************************************************
 * File Name    : HookUserActivity
 * Creator      : mq
 * Create Time  : 2019-02-23 17:55:34
 * Description  : 
 * Remark       : 
 * 
 * 
...
namespace TestHook
{
    ...
    public class HookUserActivity
    {
        ...
        public event Action<bool> MouseLeftButtonUp;
        #endregion
        ...
        /// 是否安装鼠标钩子
        /// </summary>
        private bool isInstallMouseHook = false;
        /// <summary>
        /// 是否安装键盘钩子
        /// </summary>
        private bool isInstallKeyboardHook = false;
        ...
        */
        ...
        public void Start()
        {
            ...
            this.Start(isInstallMouseHook, isInstallKeyboardHook);
        }
        ...
        /// <returns></returns>
        private int KeyboardEventHandling(int nCode, Int32 wParam, IntPtr lParam)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private int GetForegroundWindowProcessID()
        {
            int processID;
